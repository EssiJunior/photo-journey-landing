...
const Mindset = () => {
    return (
        <Section>
            <div className='mindset-shadow mx-auto grid place-items-center w-full max-w-[968px] rounded-[600px] bg-linear-to-r from-primary to-secondary text-white py-11 px-22 gap-8'>
