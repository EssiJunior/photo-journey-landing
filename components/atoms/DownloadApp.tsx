    ...
    return (
        <Link href="#" className="flex-center gap-1.5 p-4 rounded-[10px] bg-white/20 hover:bg-white/30 transition-all duration-200 ease-in-out">
            ...
            <div className="flex  flex-col gap-1.5">
                <span className="text-[10px] text-white/80 font-libre tracking-[2%] leading-[100%]">{hint}</span>
                <span className="text-[14px] font-libre tracking-[2%] leading-[100%]">{store}</span>
            </div>
        </Link>
    )
}
